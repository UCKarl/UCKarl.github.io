...
description: "Sampling Labels in Deep Learning"
categories: articles
comments: false
date: 2016-11-10
tags: [software]
...
So we trained on flickr data...lots of it. And then, we did some example image retrieval by quering random words and seeing what we came up with. Mind you, the vocabulary in YFCC100M is ginormous and you can choose any word you want to search for. (There was a few exceptions when we presented at GTC; someone yelled out "Brexit", and since our data scrape was in 2015, it wasn't in our vocabulary.) 
