...
You may have heard of this little thing called deep learning. It works great, but they have mostly been trained with only a thousand labels on heavily curated, iconic, single-labeled words. Something like the YFCC dataset, though, has millions of labels. I ended up cutting it off at 400,000, but even that many words is difficult to accomodate on the GPU. In order to extend traditional methods, I'd have to go from:

![Small Neural Network](https://raw.githubusercontent.com/UCKarl/UCKarl.github.io/master/_posts/academic/images/smallnn.jpg)
