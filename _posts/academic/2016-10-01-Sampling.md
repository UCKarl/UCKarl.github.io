...
The core of word2vec is the use of sampling. The functiona as written in the paper is:
...
Lots of people have talked about im2vec, but no one has successfully done so on large scale datasets.
